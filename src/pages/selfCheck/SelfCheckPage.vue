...
// 예시 질문 데이터
const questions = [
  { id: 1, type: 'radio', title: '본인을 포함한 세대구성원이 현재 주택을 소유 중인가요?', options: ['본인만 주택 소유', '본인 외 가족만 주택 소유', '모두 무주택'] },
  { id: 2, type: 'radio', title: '다음 중 해당되는 것을 골라주세요.', options: ['미혼', '기혼(맞벌이)', '기혼(외벌이)'] },
  { id: 3, type: 'number', title: '세대원 수와 자녀 수를 입력해주세요.', options: ['세대원', '자녀'] },
  { id: 4, type: 'radio', title: '세대 전체가 보유하고 있는 총 자산이 얼마인가요?', options: ['1억 이하', '2억 3천 이하', '3억 이하', '3억 8천 이하'] },
  { id: 5, type: 'radio', title: '세대 전체가 보유하고 있는 총 자산이 얼마인가요?', options: ['1억 이하', '2억 3천 이하', '3억 이하', '3억 8천 이하'] },
  { id: 6, type: 'radio', title: '세대구성원이 보유하고 있는 가장 비싼 차량 가격은 얼마인가요?', options: ['없음', '3,700만원 이하', '4,500만원 이하', '4,500만원 초과'] },
  { id: 7, type: 'radio', title: '청약 통장이 있나요?', options: ['있음', '없음'] },
];
